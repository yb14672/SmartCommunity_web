    ...
    <div class="login_box">
      ...
      <el-form :model="loginForm" ref="LoginFormRef" :rules="loginFormRules" label-width="0px" class="login_form">
        ...
        <el-form-item class="btns">
          <el-button type="primary" @keyup.enter="keyDown(e)" @click="login">登录</el-button>
          <el-button type="info" @click="resetLoginForm">重置</el-button>
        </el-form-item>
        <el-dialog :visible.sync="dialogVisible" title="滑动验证" class="slideContainer" width="350px" append-to-body
